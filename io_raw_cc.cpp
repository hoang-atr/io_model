 ...
 * io_raw.cpp
 *
 * This program generates soma membrane potential of 3x3 IO neurons
 * Using: ./io_raw [$trial] [$gc] [$gi] [$synaptic_input]
 *
 * Input:
...
int main( int argc , char **argv ){
    if (argc < 7) {
        ...
        cout << "Usage: ./io_raw [$trial] [$nstep] [$gc] [$gi] [$synaptic_input] [$Iapp]" << endl;
    ...
    for (size_t n=0; n<nstep; ++n) {
        t = integrate_n_steps( rk4 , io_model_cc() , v , t , dt , 10);
